...
\item Decrypt the file with \subscr{MainKey}{A} and verify signature with \subscr{UVK}{A} (now Alice has her own information from step 1 about Bob's identity and the team T)
