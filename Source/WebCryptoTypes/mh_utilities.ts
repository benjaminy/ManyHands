...
/// <reference path="LibraryTypes/es6.d.ts" />
/// <reference path="LibraryTypes/es6-promise.d.ts" />
/// <reference path="LibraryTypes/text-encoding.d.ts" />
/// <reference path="LibraryTypes/v8.d.ts" />

import { Scope, scp } from './scope';

var P               = Promise;

var encoding = 'utf-8';
export const [ encode, decode ] = encodeDecodeFunctions( encoding );
...
function hexToBuf( hex : string, scp: scp )
{
...
function array_zip( a1, a2, flatten1, flatten2, strict1, strict2, scp : scp )
{
